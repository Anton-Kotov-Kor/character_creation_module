...
def attack(char_name: str, char_class: str) -> str:
    """Функция для вычисления нанесеного урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция для вычисления блокируемого урона."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} неблокировал урон')


def special(char_name: str, char_class: str) -> str:
    """Функция для специального скила."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не применил специальную способность')
